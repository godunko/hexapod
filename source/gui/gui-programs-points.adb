...
package body GUI.Programs.Points is
   ...
   procedure Initialize (Self : in out Point_Program'Class) is
   begin
   ...
   overriding function Link (Self : in out Point_Program) return Boolean is
   begin
